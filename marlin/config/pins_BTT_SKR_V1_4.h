...
// Servos
//
// Big Plotter: both servos live on the X/Y endstop ports (no switches on
// this machine; origin is set with G92). Endstop "pins" are remapped to
// the unused Z-stop / E0DET pins so they exist but never trigger.
#define SERVO0_PIN                         P1_29  // X-STOP port: pen lift (M280 P0)
#define SERVO1_PIN                         P1_28  // Y-STOP port: color select (M280 P1)
...
//
  ...
  #endif
#else
  #define X_STOP_PIN                       P1_27  // Big Plotter: was P1_29 (X-STOP), now the pen servo
#endif
  ...
  #endif
#else
  #define Y_STOP_PIN                       P1_26  // Big Plotter: was P1_28 (Y-STOP), now the color servo
#endif
...
#define Y2_STEP_PIN                         P0_22
#define Y2_DIR_PIN                          P2_11
#define Y2_ENABLE_PIN                       P0_21
#ifndef Y2_CS_PIN
